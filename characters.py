...
CharacterRef = [
    ### A ###
    'Adé Kébé', 'Aiden Froste', 'Aitor Cazador', 'Alan Master', 'Alan Master (Neo Japón)', 'Anton Graziuso', 'Aquilina Schiller',
    ...
    ### G ###
    'Gabriel García', 'Gabriel García (Chrono Stones)', 'Gamma', 'Gigi Blasi', 'Ganymede', 'Gazelle', 'Gele', 'Gocker', 'Godric Wyles', 
